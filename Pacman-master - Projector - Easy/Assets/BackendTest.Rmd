...
```{r import}
dataPath = paste("nooramin_data", dataIndex,".txt", sep = "")
...
while(file.exists(paste("nooramin_data", dataIndex,".txt", sep = "")))
{
  df = read.table(paste("nooramin_data", dataIndex,".txt", sep = ""), header = TRUE)
  dataIndex = dataIndex + 1;
  i = 1
